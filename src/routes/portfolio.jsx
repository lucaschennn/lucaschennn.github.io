...
function Portfolio() {
    ...
    const photos = [
        ...
        [
            ...
            { id: 15, caption: "Olivier Nkamhoua delivers a dunk against Youngstown State. 11/10/2023"},
            { id: 16, caption: "CNN anchor Jake Tapper visits the University of Michigan to join Director of the Wallace House Lynette Clemetson in a conversation about democracy. 11/03/2023"},
        ]
        ,
        [
